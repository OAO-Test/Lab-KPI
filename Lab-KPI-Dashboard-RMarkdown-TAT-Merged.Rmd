...
Today <- as.timeDate(as.Date("07/23/2020", format = "%m/%d/%Y"))


#Determine if yesterday was a holiday/weekend 
#get yesterday's DOW
# Yesterday <- as.timeDate(format(Sys.Date()-1,"%m/%d/%Y"))
Yesterday <- as.timeDate(as.Date("07/22/2020", format = "%m/%d/%Y"))
...
<h4><b>Turnaround Time Exclusions</b></n4>
