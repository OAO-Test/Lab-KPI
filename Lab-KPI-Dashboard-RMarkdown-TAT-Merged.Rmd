...
if (list.files("J://") == "Presidents") {
  user_directory <- "J:/Presidents/HSPI-PM/
  Operations Analytics and Optimization/Projects/Service Lines/Lab Kpi/Data"
} else {
  user_directory <- "J:/deans/Presidents/HSPI-PM/
  Operations Analytics and Optimization/Projects/Service Lines/Lab Kpi/Data"
}
...
test_results <- scc_sun_all_days_subset %>%
  ...
  summarize(ReceiveResultPercent = sum(TotalReceiveResultInTarget)/
              sum(TotalResultedTAT)*100, 
            CollectResultPercent = sum(TotalCollectResultInTarget)/
              sum(TotalResultedTAT)*100)
