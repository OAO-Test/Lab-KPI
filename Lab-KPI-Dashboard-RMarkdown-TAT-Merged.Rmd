...
# Remove labs from master data frame that were resulted at exactly midnight on next morning
scc_sun_wday_master <- scc_sun_wday_master[!(scc_sun_wday_master$ResultDate > min(scc_sun_wday_master$ResultDate)), ]

if (scenario == 1) {
  scc_sun_not_wday_master <- scc_sun_not_wday_master[!(scc_sun_not_wday_master$ResultDate > (min(scc_sun_not_wday_master$ResultDate) + 2)), ]
} else if (scenario == 2) {
  scc_sun_not_wday_master <- scc_sun_not_wday_master[!(scc_sun_not_wday_master$ResultDate > (min(scc_sun_not_wday_master$ResultDate) + 1)), ]
} else if (scenario == 3) {
  scc_sun_not_wday_master <- scc_sun_not_wday_master[!(scc_sun_not_wday_master$ResultDate > min(scc_sun_not_wday_master$ResultDate)), ]
}
...
scc_sun_all_days_subset <- scc_sun_all_days_master %>%
...
scc_sun_repo <- rbind(scc_sun_all_days_subset)

# Add data to historical repository
write_xlsx(scc_sun_all_days_subset, path = paste0(user_wd, "\\SCC Sunquest Script Repo", "\\Hist Repo Test", Sys.Date(), ".xlsx"))
