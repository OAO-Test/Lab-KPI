...
Historical_Repo <- read.csv("J:\\deans\\Presidents\\HSPI-PM\\Operations Analytics and Optimization\\Projects\\Service Lines\\Lab KPI\\Data\\Historical_Repo_Surgical_Pathology.csv", stringsAsFactors = FALSE)
...
ggplot()+
  ...
  geom_line(data = historical_30_day_period_vol_breast_MSH, aes(x = Signed_out_date_only, y = No_cases_signed_out/100), linetype = "dashed")+ 
  geom_point(data = historical_30_day_period_vol_breast_MSH, aes(x = Signed_out_date_only, y = No_cases_signed_out/100), size = 3, shape = 4, fill = "#7F7F7F")+
  ...
  scale_y_continuous(name = "Percentage of Labs",limits = c(0,1), labels = percent, sec.axis = sec_axis(~.*100, name = "Labs Volume")) +
