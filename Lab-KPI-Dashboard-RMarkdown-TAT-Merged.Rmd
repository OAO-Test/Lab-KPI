...
colnames(Table_Template_backlog_Accessioned) <- c("spec_group", "Total_Accessioned_Volume", "Cyto_Backlog", "percentile_25th", "percentile_50th", "percentile_75th")
...
Backlog_Accessioned_Table_New2 %>% 
  kable(escape = F, align = "c", col.names = c("Case Type","Cases Accessioned","Backlog Volume", "Backlog Days (25th Percentile)", "Backlog Days (50th Percentile)", "Backlog Days (75th Percentile)")) %>%
  kable_styling(bootstrap_options = "hover", full_width = FALSE, position = "center", row_label_position = "c", font_size = 11) %>%
