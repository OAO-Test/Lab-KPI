...
last_day_in_reporting_period <- Ordered_Dates[30] 
first_day_in_reporting_period <- Ordered_Dates[1]
...
historical_30_day_period_breast_MSH <- historical_30_day_period[historical_30_day_period$Spec_group == "Breast"& (historical_30_day_period$Patient_setting == "Amb" | historical_30_day_period$Patient_setting == "IP") & historical_30_day_period$Facility == "MSH",]

ggplot(historical_30_day_period_breast_MSH, aes(x = Signed_out_date_only, y = Lab_metric_within_target, group= Patient_setting)) + 
  geom_point() +
  geom_line()
