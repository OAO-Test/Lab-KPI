...
if (is.null(Surgical_Pathology_Table_Not_Weekday_New3)){
  asis_output('<h3> No Signed Out Cases </h3>')
} else {
...
if (is.null(Cytology_Table_Not_Weekday_New3)){
  asis_output('<h3> No Signed Out Cases </h3>')
} else{
...
if  (is.null(Surgical_Pathology_Stratified_Vol_Not_Weekday_New2)){
  asis_output('<h3> No Signed Out Cases </h3>')
} else{
...
if (is.null(Cytology_Stratified_Vol_Not_Weekday_New2)){
  asis_output('<h3> No Signed Out Cases </h3>')
} else{
