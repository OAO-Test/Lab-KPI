...
Today <- as.timeDate(as.Date("01/27/2020", format = "%m/%d/%Y"))

#Determine if yesterday was a holiday/weekend 
#get yesterday's DOW
# Yesterday <- as.timeDate(format(Sys.Date()-1,"%m/%d/%Y"))
Yesterday <- as.timeDate(as.Date("01/26/2020", format = "%m/%d/%Y"))
...
<!-- Begin weekend/holiday dashboard visualizations -->
...
<!-- Start new tabset for weekend/holiday volume lookback -->
