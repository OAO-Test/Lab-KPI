...
Today <- as.timeDate(as.Date("01/31/2020", format = "%m/%d/%Y"))

#Determine if yesterday was a holiday/weekend 
#get yesterday's DOW
# Yesterday <- as.timeDate(format(Sys.Date()-1,"%m/%d/%Y"))
Yesterday <- as.timeDate(as.Date("01/30/2020", format = "%m/%d/%Y"))
...
if(((Holiday_Det) & (Yesterday_Day =="Mon"))|((Yesterday_Day =="Sun") & (isHoliday(Yesterday-(86400*2))))){ # Scenario 1: Mon Holiday or Friday Holiday (Need to select 4 files)
  # Import SCC data
  SCC_Holiday_Monday_or_Friday <- read_excel(choose.files(default = user_path, caption = "Select SCC Report for Labs Resulted on a Holiday"), sheet = 1, col_names = TRUE)
  ...
  SCC_Weekday <- read_excel(choose.files(default = user_path, caption = "Select SCC Report for Labs Resulted on a Weekday"), sheet = 1, col_names = TRUE)
  # 
  # Import Sunquest data
  SQ_Holiday_Monday_or_Friday <- read_excel(choose.files(default = user_path, caption = "Select Sunquest Report for Labs Resulted on a Holiday"), sheet = 1, col_names = TRUE)
  SQ_Sunday <- read_excel(choose.files(default = user_path, caption = "Select Sunquest Report for Labs Resulted on Sunday"), sheet = 1, col_names = TRUE)
  SQ_Saturday <- read_excel(choose.files(default = user_path, caption = "Select Sunquest Report for Labs Resulted on a Saturday"), sheet = 1, col_names = TRUE)
  #Merge the weekend data with the holiday data in one data frame
  SQ_Not_Weekday <- rbind(SQ_Holiday_Monday_or_Friday, SQ_Sunday, SQ_Saturday)
  SQ_Weekday <- read_excel(choose.files(default = user_path, caption = "Select Sunquest Report for Labs Resulted on a Weekday"), sheet = 1, col_names = TRUE)
  #
  # Import Powerpath data
  PP_Holiday_Monday_or_Friday <- read_excel(choose.files(default = user_path, caption = "Select PowerPath Report for Labs Resulted on a Holiday"), skip = 1, 1)
  PP_Holiday_Monday_or_Friday  <- PP_Holiday_Monday_or_Friday[-nrow(PP_Holiday_Monday_or_Friday),]
  PP_Sunday <- read_excel(choose.files(default = user_path, caption = "Select PowerPath Report for Labs Resulted on Sunday"), skip = 1, 1)
  PP_Sunday <- PP_Sunday[-nrow(PP_Sunday),]
  PP_Saturday <- read_excel(choose.files(default = user_path, caption = "Select PowerPath Report for Labs Resulted on Saturday"), skip = 1, 1)
  ...
  PP_Weekday <- read_excel(choose.files(default = user_path, caption = "Select PowerPath Report for Labs Resulted on a Weekday"), skip = 1, 1)
  ...
  # Import Sunquest data
  SQ_Sunday <- read_excel(choose.files(default = user_path, caption = "Select Sunquest Report for Labs Resulted on Sunday"), sheet = 1, col_names = TRUE)
  SQ_Saturday <- read_excel(choose.files(default = user_path, caption = "Select Sunquest Report for Labs Resulted on Saturday"), sheet = 1, col_names = TRUE)
  #Merge the weekend data with the holiday data in one data frame
  ...
  #
  # Import SCC data
  SCC_Holiday_Weekday <- read_excel(choose.files(default = user_path, caption = "Select SCC Report for Labs Resulted on a Holiday"), sheet = 1, col_names = TRUE)
  SCC_Not_Weekday <- SCC_Holiday_Weekday
  SCC_Weekday <- read_excel(choose.files(default = user_path, caption = "Select SCC Report for Labs Resulted on a Weekday"), sheet = 1, col_names = TRUE)
  #
  # Import Sunquest data
  SQ_Holiday_Weekday <- read_excel(choose.files(default = user_path, caption = "Select Sunquest Report for Labs Resulted on a Holiday"), sheet = 1, col_names = TRUE)
  SQ_Not_Weekday <- SQ_Holiday_Weekday
  SQ_Weekday <- read_excel(choose.files(default = user_path, caption = "Select Sunquest Report for Labs Resulted on a Weekday"), sheet = 1, col_names = TRUE)
  #
  # Import Powerpath data
  PP_Holiday_Weekday <- read_excel(choose.files(default = user_path, caption = "Select PowerPath Report for Labs Resulted on a Holiday"), skip = 1, 1)
