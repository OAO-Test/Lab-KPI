...
old_function_list <- preprocess_scc_sun(raw_scc = SCC_Weekday, raw_sun = SQ_Weekday)
new_function_list <-preprocess_scc_sun_newfunc(raw_scc = SCC_Weekday, raw_sun = SQ_Weekday)

identical(new_function_list[1], raw_scc_test)
