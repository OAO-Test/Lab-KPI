...
lab_sum_summarize_new <- function(data, LabDivision) {
  ...
  lab_div_df_templ <- test_site_prty_setting_templ %>%
    mutate(Incl = NULL) %>%
...
chem_list_test <- lab_sum_summarize_new(data = scc_sun_wday_master,
                                        LabDivision = "Chemistry")
...
chem_hem_micro_kable(chem_cast_test)

hem_list_test <- lab_sum_summarize_new(data = scc_sun_wday_master,
                                        LabDivision = "Hematology")
...
chem_hem_micro_kable(hem_cast_test)

micro_list_test <- lab_sum_summarize_new(data = scc_sun_wday_master,
                                         LabDivision = "Microbiology RRL")
...
chem_hem_micro_kable(micro_tat_vol_cast)
