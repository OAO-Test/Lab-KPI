...
source(here::here("Lab KPI Daily Dashboard/Daily_Raw_Data_Auto_Import.R"))
```
...
source(here::here(paste0("Lab KPI Daily Dashboard",
                         "/Daily_CP_PreProcessing_Analysis.R")))
```
...
### Surgical Pathology
#### *Surgical Pathology KPI (Specimens Resulted on `r result_date_text`)*
<h5>Status Definitions: <span style = "color:red">Red:</span> <80%, 
<span style = "color:orange">Yellow:</span> >=80% & <90%,
<span style = "color:green">Green:</span> >=90%</h5>
...
### Cytology
#### *Cytology KPI (Specimens Resulted on `r result_date_text`)*
<h5>Status Definitions: <span style = "color:red">Red:</span> <80%, 
<span style = "color:orange">Yellow:</span> >=80% & <90%,
<span style = "color:green">Green:</span> >=90%</h5>
...
### Surgical Pathology
#### *Surgical Pathology Signed Out Cases Volume (As of `r result_date_text`)*
