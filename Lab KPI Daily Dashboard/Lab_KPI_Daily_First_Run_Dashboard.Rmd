...
cyto_weekday_final <- cyto_prep(epic_data_raw, pp_data_raw)
...
sp_weekday <- patho_prep(pp_data_raw, gi_codes)
...
chem_vol_wday_table <- summarize_cp_vol(x = cp_summary,
                                        lab_division = "Chemistry")
...
hem_vol_wday_table <- summarize_cp_vol(x = cp_summary,
                                       lab_division = "Hematology")
...
inf_vol_wday_table <- summarize_cp_vol(x = cp_summary,
                                       lab_division = "Infusion")
