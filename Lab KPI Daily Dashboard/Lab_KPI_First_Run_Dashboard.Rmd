...
cyto_table_weekday_summarized <- pre_processing_pp(cyto_weekday_final,
                                                   wkday_date)[[1]]
...
cyto_table_weekday_raw <-
  pre_processing_pp(cyto_weekday_final,wkday_date)[[2]]

# a function to prepare surgical pathology data for pre-processing
sp_weekday <- patho_prep(pp_weekday, gi_codes)

#this table gives the summarized surgical pathology data for historical repo
sp_table_weekday_summarized <- pre_processing_pp(sp_weekday,
                                                 wkday_date)[[1]]
...
sp_table_weekday_raw <-
  pre_processing_pp(sp_weekday, wkday_date)[[2]]
...
cyto_backlog_summarized <- pre_processing_backlog(cyto_backlog_raw, wkday_date)
