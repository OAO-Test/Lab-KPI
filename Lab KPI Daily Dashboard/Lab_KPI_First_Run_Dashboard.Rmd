...
# 
# ap_start_date <-
#   format(min(hist_repo_ap_updated$Signed_out_date_only), "%m-%d-%y")
# ap_end_date <-
#   format(max(hist_repo_ap_updated$Signed_out_date_only), "%m-%d-%y")
# 
...
# 
# saveRDS(hist_repo_ap_updated, file = ap_repo_file_name)
# 
# #5. subset ap repo correctly to make sure only cases signed out yesterday are
# #included --> exclude anything signed out today at 12am
# # Subset AP data for most recent weekday
# ap_wday_summary <- hist_repo_ap_updated %>%
