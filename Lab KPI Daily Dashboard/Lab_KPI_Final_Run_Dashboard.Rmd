...
```{r repository_import file, warning = FALSE, message = FALSE, echo = FALSE}
#######
...
#######
source(here::here("Lab KPI Daily Dashboard/Repository_Import.R"))
```
...
### Infusion       
#### *Infusion KPI (Labs Resulted on `r wday_result_date`)*
<h5>Status Definitions: <span style = "color:red">Red:</span> <80%, 
...
### Infusion
#### *Infusion Resulted Lab Volume (Labs Resulted on `r wday_result_date`)*
