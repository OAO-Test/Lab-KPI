...
#### *Chemistry KPI for Labs Resulted on `r wday_result_date`*
...
#### *Hematology KPI for Labs Resulted on `r wday_result_date`*
<h5>Status Definitions: <span style = "color:red">Red:</span> <80%, 
<span style = "color:orange">Yellow:</span> >=80% & <95%,
<span style = "color:green">Green:</span> >=95%</h5>
...
#### *Microbiology RRL KPI for Labs Resulted on `r wday_result_date`*
<h5>Status Definitions: <span style = "color:red">Red:</span> <80%, 
<span style = "color:orange">Yellow:</span> >=80% & <95%,
<span style = "color:green">Green:</span> >=95%</h5>
...
#### *Missing Collection Times and Add On Order Volume for Labs Resulted on `r wday_result_date`*
...
# cat('#### *Chemistry KPI for Labs Resulted on WEEKEND/HOLIDAY PLACEHOLDER*', wday_result_date, '\n')

```

```{r Chemistry dashboard table for weekends and holidays, eval = include_not_wday, warning = FALSE, message = FALSE, echo = FALSE}
asis_output(paste('<h4> *Chemistry KPI for Labs Resulted on WEEKEND/HOLIDAY PLACEHOLDER', wkend_holiday_result_date, '*</h4>'))
...
asis_output(paste('<h4> *Hematology KPI for Labs Resulted on WEEKEND/HOLIDAY PLACEHOLDER', wkend_holiday_result_date, '*</h4>'))
asis_output('<h5>Status Definitions: <span style = "color:red">Red:</span> <80%, <span style = "color:orange">Yellow:</span> >=80% & <95%, <span style = "color:green">Green:</span> >=95%</h5>')
...
asis_output(paste('<h4> *Microbiology RRL KPI for Labs Resulted on WEEKEND/HOLIDAY PLACEHOLDER', wkend_holiday_result_date, '*</h4>'))
asis_output('<h5>Status Definitions: <span style = "color:red">Red:</span> <80%, <span style = "color:orange">Yellow:</span> >=80% & <95%, <span style = "color:green">Green:</span> >=95%</h5>')
...
asis_output(paste('<h4>*Missing Collection Times and Add On Order Volume for Labs Resulted on WEEKEND/HOLIDAY PLACEHOLDER', wkend_holiday_result_date, '*</h4>'))
