...
# Begin by subsetting Chemistry data to be included in TAT analysis
...
chemistry2 <- chemistry[!(((chemistry$Test == "Troponin" | chemistry$Test == "Lactate WB") & (chemistry$DashboardPriority != "All" | chemistry$DashboardSetting == "Amb")) | (chemistry$Test == "BUN" & chemistry$DashboardPriority == "All") | (chemistry$DashboardPriority == "Routine" & chemistry$DashboardSetting == "ED & ICU")),]
...
chemistry2 <- clean_summarized_data(chemistry2)
...
chemistry_dashboard <- chemistry_dashboard %>%
...
add_on_table %>%
  kable(format = "html", escape = FALSE, align = "c", 
        col.names = c("Test", "MSH", "MSQ", "MSBI", "MSB", "MSW", "MSSL")) %>%
  kable_styling(bootstrap = "hover", position = "center", font_size = 11) %>%
