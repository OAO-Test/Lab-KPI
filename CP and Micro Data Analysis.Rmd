...
if (is.null(scc_sun_wday_master)) {
  resulted_date_not_wday <- NULL
} else {
  resulted_date_not_wday <- unique(date(scc_sun_not_wday_master$ResultTime))
  resulted_date_not_wday_header <- format(resulted_date_not_wday, format = "%a %m/%d/%y")
}
...
#### *Chemistry KPI for Labs Resulted on `r resulted_date_wday_header`*
...
#### *Hematology KPI for Labs Resulted on `r resulted_date_wday_header`*
<h5>Status Definitions: <span style = "color:red">Red:</span> <80%, 
<span style = "color:orange">Yellow:</span> >=80% & <90%,
<span style = "color:green">Green:</span> >=90%</h5>
...
#### *Microbiology RRL KPI for Labs Resulted on `r resulted_date_wday_header`*
<h5>Status Definitions: <span style = "color:red">Red:</span> <80%, 
<span style = "color:orange">Yellow:</span> >=80% & <90%,
<span style = "color:green">Green:</span> >=90%</h5>
...
#### *Missing Collection Times and Add On Order Volume for Labs Resulted on `r resulted_date_wday_header`*
...
```{r Test block for conditional headers, results = 'asis', eval = include_not_wday}
cat('#### *Chemistry KPI for Labs Resulted on WEEKEND/HOLIDAY PLACEHOLDER*', '\n')
```

```{r Chemistry dashboard table for weekends and holidays, eval = include_not_wday, warning = FALSE, message = FALSE, echo = FALSE}
cat('#### *Chemistry KPI for Labs Resulted on WEEKEND/HOLIDAY PLACEHOLDER*', '\n')
print("Chemistry KPI for Weekends/Holidays")
...
print("Hematology KPI for Weekends/Holidays")
chem_hem_micro_kable(hem_table_not_wday)
```

```{r Microbiology RRL volume and TAT table creation for weekends/holidays, warning = FALSE, message = FALSE, echo = FALSE}
...
print("Microbiology KPI for Weekends/Holidays")
...
print("Missing Collections Table for Weekends/Holidays")
