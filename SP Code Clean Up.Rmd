...
cyto_table_weekday_summarized <- preProcessingPP(cyto_weekday_final)[[5]]

#this table gives the summarized surgical pathology data for historical repo
sp_table_weekday_summarized <- preProcessingPP(sp_weekday)[[5]]
...
xlsxFileName <- paste0(user_directory, "/AP & Cytology Historical Repo/", 
...
cyto_table_weekday_new2 <- tableMergingCyto(cyto_table_weekday)

cyto_table_not_weekday_new2 <- tableMergingCyto(cyto_table_not_weekday)

#final cyto summarized table with an assumption that 
#received to result is centralized
cyto_table_weekday_new2_v2 <- tableMergingCytoV2(cyto_table_weekday_v2)

cyto_table_not_weekday_new2_v2 <- tableMergingCytoV2(cyto_table_not_weekday_v2)
...
#received to result is not centralized
sp_table_weekday_new2 <- tableMergingPatho(sp_table_weekday)
...
sp_strat_vol_weekday_new2 <- tableMergingVolume(
...
cyto_strat_vol_weekday_new2 <- tableMergingVolume(
  table_temp_cyto_vol,
  cyto_strat_vol_weekday,
...
cyto_table_weekday_new3 <- conditionalFormattingCyto(cyto_table_weekday_new2)
...
kpi_form_today <- kpi_form_today[which(kpi_form_today$duplicated_id == "FALSE"), ]
...
formatted_clinical_labs_melt_new2$Facility <-
  rownames(formatted_clinical_labs_melt_new2)
...
tableFormattingVolume(cyto_strat_vol_weekday_new2, cyto_vol_column_names)
```
