...
ggplot() +
  ...
  scale_linetype_manual(name = "Resulted Volume", values = "dashed", labels = "All Settings") + #, guide = guide_legend(override.aes = list(color = "#959595", linetype = "dashed", shape = 18))) +
