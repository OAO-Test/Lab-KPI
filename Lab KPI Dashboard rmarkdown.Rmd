...
Cytology_Backlog_Raw <- data.frame(Cytology_Backlog[-nrow(Cytology_Backlog),], stringsAsFactors = FALSE)
...
Table_Formatting <- function (Table_New3){
  if (is.null(Table_New3)){
    ...
    Table_New3%>%
    select(everything()) %>%
    kable(escape = F, align = "c",caption = paste("Report Creation Date:", Today), color = "black", col.names = c("Case Type","Target","Setting","No. Cases Signed","MSH", "MSSM","MSQ","MSBI","PACC","MSB","MSW","MSSL", "NYEE","MSH", "MSSM","MSQ","MSBI","PACC","MSB","MSW","MSSL", "NYEE")) %>%
...
#### Surgical Pathology Efficiency Indicator (Weekday)
...
```
#### Cytology Efficiency Indicator (Weekday)
...
kable(escape = F, align = "c",caption = paste("Report Creation Date:", Today), color = "black", col.names = c("Case Type","Cases Accessioned","Backlog Volume")) %>%
    ...
    row_spec(1:2, background = "white")%>%
    row_spec(0, color = "white") %>%
    column_spec(1, color = "grey", include_thead = TRUE)
```

#### Surgical Pathology Efficiency Indicator (Weekend or/and Holiday)
```{r Surgical Pathology Efficiency Indicator Weekend/Holiday, echo=FALSE, warning=FALSE, message=FALSE}
Table_Formatting(Surgical_Pathology_Table_Not_Weekday_New3)
```

#### Cytology Efficiency Indicator (Weekend or/and Holiday)
```{r Cytology Efficiency Indicators Weekend/Holiday, echo=FALSE, warning=FALSE, message=FALSE}
