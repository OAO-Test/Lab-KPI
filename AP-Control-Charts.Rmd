...
patient_TAT_AP_plot <- function(historical_30_day_period_sum_CTR, test_name, site_name, metric) {
...
stratified_data_for_AP_charts <- function(historical_30_day_period_sum_RTR, historical_30_day_period_sum_CTR, historical_30_day_period_sum_vol, test_name){
  ...
  for (site_CTR in sites_CTR){
    print(patient_TAT_AP_plot(historical_30_day_period_sum_CTR = historical_30_day_period_sum_CTR, test_name = test_name, site_name = site_CTR, metric = "Patient_metric_avg"))
  }
