...
Formatted_Clinical_Labs_Melt_New3 <- Formatted_Clinical_Labs_Melt_New2[,c(1:10)]

Comments_Clinical_Labs <- Formatted_Clinical_Labs_Melt_New2[,c(1,11)]
...
Formatted_Blood_Bank_Melt_New3 <- Formatted_Blood_Bank_Melt_New2[,c(1:9)]

Comments_Blood_Bank <- Formatted_Blood_Bank_Melt_New2[,c(1,10)]
Comments_Blood_Bank[is.na(Comments_Blood_Bank)] <- "No Issues Reported (Safe)"
...
Formatted_Blood_Bank_Melt_New3%>%
    select(everything()) %>%
